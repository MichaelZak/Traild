       ...
       */
        ...
        */
        ...
        /*
			Modified for Trails
        */
         orderByDistanceTrails: function(latlng, coords) {
            var coordsArray = [];

            for(var i = 0; i < coords.length; i++) {
            	var trailCoord = {
            		"latitude": coords[i].origin.lat, 
            		"longitude": coords[i].origin.lng
            	};

                var d = this.getDistance(latlng, trailCoord);
                coordsArray.push({
                    key: coords[i],
                    // latitude: this.latitude(coords[i].origin.lat),
                    // longitude: this.longitude(coords[i].origin.lng),
                    distance: d
                });
